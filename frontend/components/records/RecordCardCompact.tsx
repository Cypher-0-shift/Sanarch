...
export default function RecordCardCompact({ id, title, subtitle }: RecordCardCompactProps) {
  ...
  return (
    <TouchableOpacity 
      className="bg-white rounded-xl shadow-sm border border-primary/5 p-4 flex-row items-center gap-4 mb-3"
    ...
    >
      ...
      <View className="flex-1">
        ...
        <Text className="text-xs text-slate-500 font-display mt-0.5">{subtitle}</Text>
      </View>
